...
{asd 123} # End curly braces, except in TCL-like languages where
          # they act like nestable double quotes.
...
and with the semantics as the TOGVM-PHP language and SchemaSchema.
...
but that seems to lead to some ambiguity:
