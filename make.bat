...
java -jar "%bootstrap_jar%" -o target/JavaProjectBuilder.jar --include-sources --java-sources=src/main/java --main-class=net.nuke24.tscript34.p0019.util.JavaProjectBuilder
rem java -jar "%bootstrap_jar%" -o target/P0019.jar --include-sources --java-sources=src/main/java --main-class=net.nuke24.tscript34.p0019.P0019
